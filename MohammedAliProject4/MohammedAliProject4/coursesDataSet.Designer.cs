...
namespace MohammedAliProject4 {
    ...
    public partial class coursesDataSet : global::System.Data.DataSet {
        ...
        public partial class CoursesDataTable : global::System.Data.TypedTableBase<CoursesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CoursesRow FindByCode(string Code) {
...
namespace MohammedAliProject4.coursesDataSetTableAdapters {
    ...
    public partial class CoursesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Courses] WHERE (([Code] = @Original_Code) AND ([Name] = @Origi" +
                "nal_Name))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Courses] ([Code], [Name]) VALUES (@Code, @Name);\r\nSELECT Code," +
                " Name FROM Courses WHERE (Code = @Code)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Courses] SET [Code] = @Code, [Name] = @Name WHERE (([Code] = @Origi" +
                "nal_Code) AND ([Name] = @Original_Name));\r\nSELECT Code, Name FROM Courses WHERE " +
                "(Code = @Code)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::MohammedAliProject4.Properties.Settings.Default.coursesConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Code, Name FROM dbo.Courses";
